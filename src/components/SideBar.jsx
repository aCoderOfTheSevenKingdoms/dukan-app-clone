export const SideBar = () => {
    ...
    return <div>
        ...
        <aside id="default-sidebar" className="fixed h-screen text-white top-0 left-0 z-40 transition-tranform -translate-x-full sm:translate-x-0">
          <div className="h-full px-3 py-4 flex flex-col gap-6 overflow-y-auto bg-blue-950">
          <div className="flex items-center gap-3">
            <div>
              <img src="/kendrick.png" alt="Logo" className="rounded h-10"></img>
            </div>

            <div>
                <p className="h-3.8 leading-5.5 text-white font-medium">OMM</p>
                <p className="underline leading-4 h-4 font-normal">Visit Store</p>
            </div>
       ...
       <div>
        <ul className="space-y-2 font-medium">
            <li>
                <a href="#" className="flex items-center p-2 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" />
   ...
   <a href="#" class="flex items-center text-gray-300 p-2 gap-2.5 rounded-lg bg-gray-700 hover:text-white group">
